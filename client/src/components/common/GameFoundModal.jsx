...
const GameFoundModal = ({ isOpen, gameSession, userData, onAccept }) => {
    ...
    return (
        <div className="modal-overlay">
            <div className="modal-content" style={{ maxWidth: '600px', textAlign: 'center', padding: '40px', background: '#1e1e1e', border: '1px solid #333' }}>
                <h1 style={{ fontSize: '2.5rem', color: '#fff', marginBottom: '20px', marginTop: 0 }}>
                    Mecz Znaleziony!
                </h1>
                ...
                <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', gap: '40px', margin: '40px 0' }}>
                    <div style={{ textAlign: 'center' }}>
                        ...
                        <h3 style={{ marginTop: '10px', marginBottom: '5px' }}>Ty</h3>
                        <span style={{ color: '#aaa', fontSize: '0.9rem' }}>ELO: {myElo}</span>
                    </div>
                    ...
                    <div style={{ textAlign: 'center' }}>
                        ...
                        <h3 style={{ marginTop: '10px', marginBottom: '5px' }}>{opponentName}</h3>
                        <span style={{ color: '#aaa', fontSize: '0.9rem' }}>ELO: {opponentElo}</span>
                    </div>
                </div>
